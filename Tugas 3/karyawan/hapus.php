...
if(isset($_GET['id'])){
	...
	$cek = mysql_query("SELECT karyawan_id FROM datakaryawan WHERE karyawan_id='$id'") or die(mysql_error());
	...
	if(mysql_num_rows($cek) == 0){
		...
		$del = mysql_query("DELETE FROM datakaryawan WHERE karyawan_id='$id'");
